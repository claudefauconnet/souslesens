...
for (var i=0;i<words.length;i++){
    ...
    if(item[j][0]=="DS") {
        ...
        if(item[j][0]=="DS")
            obj.related==item[0][1]   ;
        if(item[j][0]=="DS"){
            obj.related==item[0][1]   ;
            if(item[j][0]=="BT"){
                obj.broader==item[0][1]   ;
                if(item[j][0]=="NT"){
                    obj.broader==item[0][1]   ;
                    if(item[j][0]=="SN"){
                        obj.altLabel==item[0][1]   ;
    }
        ...
        var line=" <skos:Concept rdf:about=\"https://www.pa.utulsa.edu/thesaurus/"+item[0][2]+"\">\n "+
            "<skos:prefLabel>item[0][1]</skos:prefLabel>\n";
