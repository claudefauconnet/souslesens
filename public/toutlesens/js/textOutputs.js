...
function printNode(node, withAttrs) {
    var str = "";
    var label = "";
    var color = "black";
...
function getRelationAttrsInfo(node) {
...
function getNodeAttrsInfo(node) {
...
function drawNodesOnlyTable(neoResult) {
...
function drawCSV_DataTable(json) {
